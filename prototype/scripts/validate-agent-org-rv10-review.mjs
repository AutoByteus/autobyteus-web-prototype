...
const evidenceRoot = path.join(ticketRoot, 'review-evidence', 'rv-010');
...
record('AORG-RV10-001-team-catalog',
...
record('AORG-RV10-002-separated-primary-navigation',
...
record('AORG-RV10-003-team-catalog-preserves-baseline-visual-language',
...
record('AORG-RV10-021-baseline-reload-feedback',
...
record('AORG-RV10-022-baseline-search-behavior',
...
await capture(teamList, 'REV-AORG-RV10-001', 'REV-AORG-RV10-001-agent-team-catalog.png', 'Baseline-native flat Agent Team catalog; only obsolete nesting semantics are removed');
...
record('AORG-RV10-004-team-authoring-agent-only',
...
record('AORG-RV10-045-team-builder-preserves-real-drag-source-and-drop-target',
...
record('AORG-RV10-005-exactly-one-team-coordinator',
...
record('AORG-RV10-046-selected-canvas-member-has-real-editable-details',
...
record('AORG-RV10-047-member-name-and-coordinator-edit-update-the-canvas',
...
await capture(teamCreate, 'REV-AORG-RV10-002', 'REV-AORG-RV10-002-agent-team-authoring.png', 'Source-native drag-and-drop Agent-only Team builder with editable selected-member details');
...
record('AORG-RV10-023-team-detail-preserves-baseline-card-hierarchy',
...
record('AORG-RV10-024-team-detail-keeps-flat-semantics-without-cross-surface-chrome',
...
await capture(teamDetail, 'REV-AORG-RV10-011', 'REV-AORG-RV10-011-agent-member-detail.png', 'Preserved Agent detail reached from a Team member');
await teamDetail.getByRole('button', { name: 'Back to team', exact: true }).click();
await teamDetail.waitForURL(/\/agent-teams\?/);
record('AORG-RV10-026-agent-detail-returns-to-future-team-context',
...
record('AORG-RV10-027-team-detail-narrow-preservation',
...
record('AORG-RV10-048-team-builder-preserves-click-fallback-and-narrow-layout',
...
await capture(narrowTeamCreate, 'REV-AORG-RV10-016', 'REV-AORG-RV10-016-agent-team-builder-narrow.png', 'Narrow Team builder with click fallback and selected-member details');
...
record('AORG-RV10-032-team-local-editor-limits-endpoints-to-direct-agents',
...
await capture(teamEdit, 'REV-AORG-RV10-013', 'REV-AORG-RV10-013-team-local-handoff-authoring.png', 'Team-local handoff editor with direct Agent endpoints only');
...
record('AORG-RV10-033-team-member-impact-blocks-atomic-save',
...
record('AORG-RV10-006-org-catalog',
...
record('AORG-RV10-007-org-direct-composition',
...
record('AORG-RV10-028-org-reload-feedback',
...
record('AORG-RV10-029-org-search-behavior',
...
await capture(orgList, 'REV-AORG-RV10-003', 'REV-AORG-RV10-003-agent-org-catalog.png', 'Baseline-native Agent Org catalog with direct Agent and Team members');
await orgList.close();
...
record('AORG-RV10-030-org-catalog-narrow-layout',
...
record('AORG-RV10-008-org-authoring-membership',
...
record('AORG-RV10-049-org-inline-member-picker',
...
record('AORG-RV10-050-org-inline-member-picker-adds-both-member-kinds',
...
record('AORG-RV10-009-org-has-no-coordinator-control',
...
await capture(orgCreate, 'REV-AORG-RV10-004', 'REV-AORG-RV10-004-agent-org-authoring.png', 'Agent Org authoring with independent Agents and referenced Teams');
...
record('AORG-RV10-053-org-inline-member-picker-narrow-layout',
...
record('AORG-RV10-010-team-reference-preservation',
...
record('AORG-RV10-034-org-description-contains-no-invented-summary-data',
...
await capture(orgDetail, 'REV-AORG-RV10-005', 'REV-AORG-RV10-005-agent-org-detail.png', 'Baseline-native Org detail with Agent and same-identity Team members');
...
record('AORG-RV10-035-org-handoff-detail-is-explicit-and-clean',
...
await capture(orgDetail, 'REV-AORG-RV10-014', 'REV-AORG-RV10-014-agent-org-handoff-detail.png', 'Clean Agent Org handoff detail with only From, To, and When');
...
record('AORG-RV10-011-org-run-opens-one-org-configuration',
...
record('AORG-RV10-012-org-configuration-preserves-baseline-run-language',
...
record('AORG-RV10-013-config-history-has-definition-without-active-runtime',
...
await capture(orgDetail, 'REV-AORG-RV10-006', 'REV-AORG-RV10-006-agent-org-configuration.png', 'Agent Org Run opens the baseline-native organization configuration directly');

await orgDetail.locator('[data-test="org-member-overrides-toggle"]').click();
record('AORG-RV10-014-org-placement-hierarchy-is-explicit',
...
record('AORG-RV10-015-team-and-agent-placement-overrides-are-editable',
...
await capture(orgDetail, 'REV-AORG-RV10-007', 'REV-AORG-RV10-007-agent-org-placement-overrides.png', 'One clean configuration tree supports Team and Agent placement overrides');
...
record('AORG-RV10-016-org-launch-validates-complete-configuration',
...
record('AORG-RV10-017-full-scope-launch-has-no-initial-focus',
...
record('AORG-RV10-018-task-agent-and-task-team-remain-runtime-lineage',
...
await capture(orgDetail, 'REV-AORG-RV10-008', 'REV-AORG-RV10-008-agent-org-active-unfocused.png', 'Complete Agent Org scope active with no initial communication focus');
...
record('AORG-RV10-019-sidebar-direct-agent-focus',
...
await capture(orgDetail, 'REV-AORG-RV10-009', 'REV-AORG-RV10-009-agent-org-direct-agent-focus.png', 'Exact direct Agent selected from the active Agent Org sidebar');
...
record('AORG-RV10-020-sidebar-team-focus-enters-through-coordinator',
  await orgDetail.locator('[data-test="agent-org-active-unfocused"]').count() === 0
...
await capture(orgDetail, 'REV-AORG-RV10-010', 'REV-AORG-RV10-010-agent-org-team-coordinator-focus.png', 'Direct Team selected from the Agent Org sidebar and communication enters through its coordinator');
...
record('AORG-RV10-021-sidebar-exact-team-agent-focus',
...
record('AORG-RV10-022-agent-org-runtime-preserves-file-tree',
...
record('AORG-RV10-036-org-handoff-editor-validates-complete-draft',
...
record('AORG-RV10-037-org-handoff-endpoint-eligibility',
...
record('AORG-RV10-038-when-conditions-are-orderable',
...
record('AORG-RV10-039-handoff-draft-can-be-canceled',
...
record('AORG-RV10-040-handoff-authoring-supports-crud-reorder-and-atomic-save',
...
await capture(orgEdit, 'REV-AORG-RV10-015', 'REV-AORG-RV10-015-agent-org-handoff-authoring.png', 'Clean Agent Org handoff authoring with From, To, and ordered When guidance');
...
record('AORG-RV10-041-saved-handoff-definition-is-inspectable',
...
record('AORG-RV10-042-self-resolving-delivery-is-rejected',
...
await orgInvalidManager.locator('[data-test="apply-handoff-draft"]').click();
record('AORG-RV10-043-duplicate-effective-pair-is-rejected',
...
record('AORG-RV10-044-org-member-impact-blocks-atomic-save',
...
record('AORG-RV10-019-narrow-layout', overflow.scrollWidth === overflow.viewport
...
record('AORG-RV10-053-org-configuration-narrow-layout',
...
await capture(narrowConfig, 'REV-AORG-RV10-017', 'REV-AORG-RV10-017-agent-org-configuration-narrow.png', 'Responsive Agent Org configuration without an overlay');
await narrowConfig.close();

record('AORG-RV10-020-no-runtime-errors', runtimeErrors.length === 0, { runtimeErrors });
...
await fs.writeFile(path.join(ticketRoot, 'browser-validation-rv-010.json'), `${JSON.stringify(result, null, 2)}\n`);
