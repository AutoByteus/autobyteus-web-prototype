...
const evidenceRoot = path.join(ticketRoot, 'review-evidence', 'rv-011');
...
record('AORG-RV11-001-team-catalog',
...
record('AORG-RV11-002-separated-primary-navigation',
...
record('AORG-RV11-003-team-catalog-preserves-baseline-visual-language',
...
record('AORG-RV11-021-baseline-reload-feedback',
...
record('AORG-RV11-022-baseline-search-behavior',
...
await capture(teamList, 'REV-AORG-RV11-001', 'REV-AORG-RV11-001-agent-team-catalog.png', 'Baseline-native flat Agent Team catalog; only obsolete nesting semantics are removed');
...
record('AORG-RV11-004-team-authoring-agent-only',
...
record('AORG-RV11-045-team-builder-preserves-real-drag-source-and-drop-target',
...
record('AORG-RV11-005-exactly-one-team-coordinator',
...
record('AORG-RV11-046-selected-canvas-member-has-real-editable-details',
...
record('AORG-RV11-047-member-name-and-coordinator-edit-update-the-canvas',
...
await capture(teamCreate, 'REV-AORG-RV11-002', 'REV-AORG-RV11-002-agent-team-authoring.png', 'Source-native drag-and-drop Agent-only Team builder with editable selected-member details');
...
record('AORG-RV11-023-team-detail-preserves-baseline-card-hierarchy',
...
record('AORG-RV11-024-team-detail-keeps-flat-semantics-without-cross-surface-chrome',
...
await capture(teamDetail, 'REV-AORG-RV11-018', 'REV-AORG-RV11-018-agent-team-detail.png', 'Baseline-native flat Team detail with members, coordinator, and handoffs');
...
record('AORG-RV11-031-team-handoff-detail-is-explicit-and-clean',
...
await capture(teamDetail, 'REV-AORG-RV11-012', 'REV-AORG-RV11-012-team-local-handoff-detail.png', 'Clean Team-local From, To, and When handoff detail');
...
await capture(teamDetail, 'REV-AORG-RV11-019', 'REV-AORG-RV11-019-agent-team-members.png', 'Preserved Team member cards with direct Agent detail actions');
...
record('AORG-RV11-025-team-member-opens-preserved-agent-detail',
...
await capture(teamDetail, 'REV-AORG-RV11-011', 'REV-AORG-RV11-011-agent-member-detail.png', 'Preserved Agent detail reached from a Team member');
await teamDetail.getByRole('button', { name: 'Back to team', exact: true }).click();
await teamDetail.waitForURL(/\/agent-teams\?/);
record('AORG-RV11-026-agent-detail-returns-to-future-team-context',
...
record('AORG-RV11-027-team-detail-narrow-preservation',
...
record('AORG-RV11-048-team-builder-preserves-click-fallback-and-narrow-layout',
...
await capture(narrowTeamCreate, 'REV-AORG-RV11-016', 'REV-AORG-RV11-016-agent-team-builder-narrow.png', 'Narrow Team builder with click fallback and selected-member details');
...
record('AORG-RV11-032-team-local-editor-limits-endpoints-to-direct-agents',
...
await capture(teamEdit, 'REV-AORG-RV11-013', 'REV-AORG-RV11-013-team-local-handoff-authoring.png', 'Team-local handoff editor with direct Agent endpoints only');
...
record('AORG-RV11-033-team-member-impact-blocks-atomic-save',
...
record('AORG-RV11-006-org-catalog',
...
record('AORG-RV11-007-org-direct-composition',
...
record('AORG-RV11-028-org-reload-feedback',
...
record('AORG-RV11-029-org-search-behavior',
...
await capture(orgList, 'REV-AORG-RV11-003', 'REV-AORG-RV11-003-agent-org-catalog.png', 'Baseline-native Agent Org catalog with direct Agent and Team members');
await orgList.close();
...
record('AORG-RV11-030-org-catalog-narrow-layout',
...
record('AORG-RV11-008-org-authoring-membership',
...
record('AORG-RV11-049-org-inline-member-picker',
...
record('AORG-RV11-050-org-inline-member-picker-adds-both-member-kinds',
...
record('AORG-RV11-009-org-has-no-coordinator-control',
...
await capture(orgCreate, 'REV-AORG-RV11-004', 'REV-AORG-RV11-004-agent-org-authoring.png', 'Agent Org authoring with independent Agents and referenced Teams');
...
record('AORG-RV11-053-org-inline-member-picker-narrow-layout',
...
await capture(narrowOrgCreate, 'REV-AORG-RV11-020', 'REV-AORG-RV11-020-agent-org-inline-member-picker-narrow.png', 'Narrow in-flow member picker without an overlay');
...
record('AORG-RV11-010-team-reference-preservation',
...
record('AORG-RV11-034-org-description-contains-no-invented-summary-data',
...
await capture(orgDetail, 'REV-AORG-RV11-005', 'REV-AORG-RV11-005-agent-org-detail.png', 'Baseline-native Org detail with Agent and same-identity Team members');
...
record('AORG-RV11-035-org-handoff-detail-is-explicit-and-clean',
...
await capture(orgDetail, 'REV-AORG-RV11-014', 'REV-AORG-RV11-014-agent-org-handoff-detail.png', 'Clean Agent Org handoff detail with only From, To, and When');
...
record('AORG-RV11-011-org-run-opens-one-org-configuration',
...
record('AORG-RV11-012-org-configuration-preserves-baseline-run-language',
...
record('AORG-RV11-013-config-history-has-definition-without-active-runtime',
...
await capture(orgDetail, 'REV-AORG-RV11-006', 'REV-AORG-RV11-006-agent-org-configuration.png', 'Agent Org Run opens the baseline-native organization configuration directly');

await orgDetail.locator('[data-test="org-member-overrides-toggle"]').click();
record('AORG-RV11-014-org-placement-hierarchy-is-explicit',
...
record('AORG-RV11-015-team-and-agent-placement-overrides-are-editable',
...
await capture(orgDetail, 'REV-AORG-RV11-007', 'REV-AORG-RV11-007-agent-org-placement-overrides.png', 'One clean configuration tree supports Team and Agent placement overrides');
...
record('AORG-RV11-016-org-launch-validates-complete-configuration',
...
record('AORG-RV11-017-full-scope-launch-has-no-initial-focus',
...
record('AORG-RV11-018-task-agent-and-task-team-remain-runtime-lineage',
...
record('AORG-RV11-054-workspace-hierarchy-preserves-source-tree-branches',
...
await capture(orgDetail, 'REV-AORG-RV11-008', 'REV-AORG-RV11-008-agent-org-active-unfocused.png', 'Complete Agent Org scope active with no initial communication focus');
...
record('AORG-RV11-019-sidebar-direct-agent-focus',
...
await capture(orgDetail, 'REV-AORG-RV11-009', 'REV-AORG-RV11-009-agent-org-direct-agent-focus.png', 'Exact direct Agent selected from the active Agent Org sidebar');
...
record('AORG-RV11-020-sidebar-team-focus-enters-through-coordinator',
  await orgDetail.locator('[data-test="agent-org-active-unfocused"]').count() === 0
...
await capture(orgDetail, 'REV-AORG-RV11-010', 'REV-AORG-RV11-010-agent-org-team-coordinator-focus.png', 'Direct Team selected from the Agent Org sidebar and communication enters through its coordinator');
...
record('AORG-RV11-021-sidebar-exact-team-agent-focus',
...
record('AORG-RV11-022-agent-org-runtime-preserves-file-tree',
...
record('AORG-RV11-036-org-handoff-editor-validates-complete-draft',
...
record('AORG-RV11-037-org-handoff-endpoint-eligibility',
...
record('AORG-RV11-038-when-conditions-are-orderable',
...
record('AORG-RV11-039-handoff-draft-can-be-canceled',
...
record('AORG-RV11-040-handoff-authoring-supports-crud-reorder-and-atomic-save',
...
await capture(orgEdit, 'REV-AORG-RV11-015', 'REV-AORG-RV11-015-agent-org-handoff-authoring.png', 'Clean Agent Org handoff authoring with From, To, and ordered When guidance');
...
record('AORG-RV11-041-saved-handoff-definition-is-inspectable',
...
record('AORG-RV11-042-self-resolving-delivery-is-rejected',
...
await orgInvalidManager.locator('[data-test="apply-handoff-draft"]').click();
record('AORG-RV11-043-duplicate-effective-pair-is-rejected',
...
record('AORG-RV11-044-org-member-impact-blocks-atomic-save',
...
record('AORG-RV11-019-narrow-layout', overflow.scrollWidth === overflow.viewport
...
record('AORG-RV11-053-org-configuration-narrow-layout',
...
await capture(narrowConfig, 'REV-AORG-RV11-017', 'REV-AORG-RV11-017-agent-org-configuration-narrow.png', 'Responsive Agent Org configuration without an overlay');
await narrowConfig.close();

record('AORG-RV11-020-no-runtime-errors', runtimeErrors.length === 0, { runtimeErrors });
...
await fs.writeFile(path.join(ticketRoot, 'browser-validation-rv-011.json'), `${JSON.stringify(result, null, 2)}\n`);
