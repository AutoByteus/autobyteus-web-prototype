...
const evidenceRoot = path.join(ticketRoot, 'review-evidence', 'rv-009');
...
record('AORG-RV9-001-team-catalog',
...
record('AORG-RV9-002-separated-primary-navigation',
...
record('AORG-RV9-003-team-catalog-preserves-baseline-visual-language',
...
record('AORG-RV9-021-baseline-reload-feedback',
...
record('AORG-RV9-022-baseline-search-behavior',
...
await capture(teamList, 'REV-AORG-RV9-001', 'REV-AORG-RV9-001-agent-team-catalog.png', 'Baseline-native flat Agent Team catalog; only obsolete nesting semantics are removed');
...
record('AORG-RV9-004-team-authoring-agent-only',
...
record('AORG-RV9-045-team-builder-preserves-real-drag-source-and-drop-target',
...
record('AORG-RV9-005-exactly-one-team-coordinator',
...
record('AORG-RV9-046-selected-canvas-member-has-real-editable-details',
...
record('AORG-RV9-047-member-name-and-coordinator-edit-update-the-canvas',
...
await capture(teamCreate, 'REV-AORG-RV9-002', 'REV-AORG-RV9-002-agent-team-authoring.png', 'Source-native drag-and-drop Agent-only Team builder with editable selected-member details');
...
record('AORG-RV9-023-team-detail-preserves-baseline-card-hierarchy',
...
record('AORG-RV9-024-team-detail-keeps-flat-semantics-without-cross-surface-chrome',
...
await capture(teamDetail, 'REV-AORG-RV9-009', 'REV-AORG-RV9-009-agent-team-detail.png', 'Baseline-native flat Team detail with members, coordinator, and handoffs');
...
record('AORG-RV9-031-team-handoff-detail-is-explicit-and-clean',
...
await capture(teamDetail, 'REV-AORG-RV9-012', 'REV-AORG-RV9-012-team-local-handoff-detail.png', 'Clean Team-local From, To, and When handoff detail');
...
await capture(teamDetail, 'REV-AORG-RV9-010', 'REV-AORG-RV9-010-agent-team-members.png', 'Preserved Team member cards with direct Agent detail actions');
...
record('AORG-RV9-025-team-member-opens-preserved-agent-detail',
...
await capture(teamDetail, 'REV-AORG-RV9-011', 'REV-AORG-RV9-011-agent-member-detail.png', 'Preserved Agent detail reached from a Team member');
await teamDetail.getByRole('button', { name: 'Back to team', exact: true }).click();
await teamDetail.waitForURL(/\/agent-teams\?/);
record('AORG-RV9-026-agent-detail-returns-to-future-team-context',
...
record('AORG-RV9-027-team-detail-narrow-preservation',
...
record('AORG-RV9-048-team-builder-preserves-click-fallback-and-narrow-layout',
...
await capture(narrowTeamCreate, 'REV-AORG-RV9-016', 'REV-AORG-RV9-016-agent-team-builder-narrow.png', 'Narrow Team builder with click fallback and selected-member details');
...
record('AORG-RV9-032-team-local-editor-limits-endpoints-to-direct-agents',
...
await capture(teamEdit, 'REV-AORG-RV9-013', 'REV-AORG-RV9-013-team-local-handoff-authoring.png', 'Team-local handoff editor with direct Agent endpoints only');
...
record('AORG-RV9-033-team-member-impact-blocks-atomic-save',
...
record('AORG-RV9-006-org-catalog',
...
record('AORG-RV9-007-org-direct-composition',
...
record('AORG-RV9-028-org-reload-feedback',
...
record('AORG-RV9-029-org-search-behavior',
...
await capture(orgList, 'REV-AORG-RV9-003', 'REV-AORG-RV9-003-agent-org-catalog.png', 'Baseline-native Agent Org catalog with direct Agent and Team members');
await orgList.close();
...
record('AORG-RV9-030-org-catalog-narrow-layout',
...
record('AORG-RV9-008-org-authoring-membership',
...
record('AORG-RV9-049-org-inline-member-picker',
...
record('AORG-RV9-050-org-inline-member-picker-adds-both-member-kinds',
...
record('AORG-RV9-009-org-has-no-coordinator-control',
...
await capture(orgCreate, 'REV-AORG-RV9-004', 'REV-AORG-RV9-004-agent-org-authoring.png', 'Agent Org authoring with independent Agents and referenced Teams');
...
record('AORG-RV9-053-org-inline-member-picker-narrow-layout',
...
await capture(narrowOrgCreate, 'REV-AORG-RV9-017', 'REV-AORG-RV9-017-agent-org-inline-member-picker-narrow.png', 'Narrow in-flow member picker without an overlay');
...
record('AORG-RV9-010-team-reference-preservation',
...
record('AORG-RV9-034-org-description-contains-no-invented-summary-data',
...
await capture(orgDetail, 'REV-AORG-RV9-005', 'REV-AORG-RV9-005-agent-org-detail.png', 'Baseline-native Org detail with Agent and same-identity Team members');
...
record('AORG-RV9-035-org-handoff-detail-is-explicit-and-clean',
...
await capture(orgDetail, 'REV-AORG-RV9-014', 'REV-AORG-RV9-014-agent-org-handoff-detail.png', 'Clean Agent Org handoff detail with only From, To, and When');
await orgDetail.getByRole('button', { name: 'Run', exact: true }).click();
await orgDetail.locator('[data-test="org-launch-modal"]').waitFor();
record('AORG-RV9-011-org-launch-requires-entry',
...
record('AORG-RV9-012-team-entry-resolves-through-coordinator',
...
await capture(orgDetail, 'REV-AORG-RV9-006', 'REV-AORG-RV9-006-agent-org-exact-entry-launch.png', 'Exact Team entry selected; Team coordinator is explicit');
...
record('AORG-RV9-013-launch-carries-exact-entry-to-baseline-team-config',
  new URL(orgDetail.url()).searchParams.get('entry') === 'team:product-design-prototyping-team'
    && await orgDetail.getByText('Team Definition', { exact: true }).count() === 1
    && await orgDetail.getByText('Product Design & Prototyping', { exact: true }).count() >= 1
    && await orgDetail.getByRole('button', { name: 'Run Team', exact: true }).isDisabled()
    && await orgDetail.getByText('Workspace is required to run a team.', { exact: true }).count() === 1
    && await orgDetail.locator('[data-test="agent-org-run-history"]').count() === 1
    && await orgDetail.locator('[data-test="history-org-root"]').count() === 0,
  { exactEntry: 'team:product-design-prototyping-team', phase: 'config', preservedSurface: 'baseline Team run configuration' });
record('AORG-RV9-014-config-history-distinguishes-definition-types-without-runtime-fiction',
  await orgDetail.locator('[data-test="history-org-definition"]').count() === 1
    ...
    && await orgDetail.getByText('Agent Org root', { exact: true }).count() === 0
    && await orgDetail.getByText('Standalone Agent Team run', { exact: true }).count() === 0
    && await orgDetail.getByText('Runtime execution lineage', { exact: true }).count() === 0,
  { configurationPhase: true, activeOrgRun: false, explanatoryRuntimeChrome: 0 });
await capture(orgDetail, 'REV-AORG-RV9-007', 'REV-AORG-RV9-007-agent-org-team-entry-config.png', 'Exact Team entry continues into the accepted Team run-configuration surface');
...
record('AORG-RV9-015-team-entry-config-enables-only-after-workspace-selection',
  await orgDetail.getByRole('button', { name: 'Run Team', exact: true }).isEnabled(),
  { workspace: '/synthetic/prototype-workspace', runAction: 'Run Team' });
await orgDetail.getByRole('button', { name: 'Run Team', exact: true }).click();
await orgDetail.waitForURL((url) => url.searchParams.get('phase') === 'active');
await orgDetail.locator('[data-test="history-org-root"]').waitFor();
record('AORG-RV9-016-org-team-runtime-reuses-baseline-workspace',
  await orgDetail.locator('[data-test="agent-org-run-history"]').count() === 1
    && await orgDetail.locator('[data-test="history-org-root"]').count() === 1
    && await orgDetail.getByText('Context Files (0)', { exact: true }).count() === 1
    && await orgDetail.getByRole('tab', { name: 'Team', exact: true }).count() === 1
    && await orgDetail.getByRole('tab', { name: 'Files', exact: true }).count() === 1
    && await orgDetail.getByText('Through coordinator product_prototyper', { exact: true }).count() === 0
    && await orgDetail.locator('[data-test="selected-runtime-execution"]').count() === 0,
  { root: 'Agent Org', runtimeSurface: 'accepted Team workspace', customDashboard: 0 });
record('AORG-RV9-017-task-agent-and-task-team-remain-runtime-lineage',
  ...
  { taskPresentation: 'temporary rows beneath the entered Team execution', authoredNestingChrome: 0 });
await orgDetail.locator('[data-test="history-task-agent-row"]').click();
record('AORG-RV9-018-task-agent-row-focuses-baseline-conversation',
  await orgDetail.getByText('Audit the prototype dependency licenses.', { exact: true }).count() === 1
    && await orgDetail.getByText('The dedicated license audit is in progress.', { exact: true }).count() === 1,
  { focused: 'task-agent-license-audit' });
await orgDetail.locator('[data-test="history-task-team-child-row"]').click();
record('AORG-RV9-019-task-team-child-focuses-baseline-conversation',
  await orgDetail.getByText('Review the implementation as a Team.', { exact: true }).count() === 1
    && await orgDetail.getByText('The temporary review Team is checking the implementation.', { exact: true }).count() === 1
    && await orgDetail.locator('[data-test="history-task-team-child-row"]').getByText('reviewer', { exact: true }).count() === 1,
  { focused: 'task-team-review:reviewer' });
await orgDetail.getByRole('tab', { name: 'Files', exact: true }).click();
record('AORG-RV9-020-agent-org-team-runtime-preserves-file-tree',
...
await capture(orgDetail, 'REV-AORG-RV9-008', 'REV-AORG-RV9-008-agent-org-team-runtime.png', 'Agent Org run in the accepted Team workspace with task Agent and task Team lineage');
await orgDetail.close();

const orgAgentRuntime = await openPage(`/workspace?${query({ root: 'org', org: 'software-development-department', entry: 'agent:requirements-engineer', phase: 'config' })}`);
record('AORG-RV9-051-direct-agent-entry-opens-baseline-agent-config',
  await orgAgentRuntime.getByText('Agent Definition', { exact: true }).count() === 1
    && await orgAgentRuntime.getByText('requirements_engineer', { exact: true }).count() >= 1
    && await orgAgentRuntime.getByRole('button', { name: 'Run Agent', exact: true }).isDisabled()
    && await orgAgentRuntime.locator('[data-test="history-org-root"]').count() === 0,
  { exactEntry: 'agent:requirements-engineer', phase: 'config' });
await orgAgentRuntime.getByRole('button', { name: 'Select a workspace...', exact: true }).click();
await orgAgentRuntime.getByText('/synthetic/prototype-workspace', { exact: true }).click();
await orgAgentRuntime.getByRole('button', { name: 'Run Agent', exact: true }).click();
await orgAgentRuntime.waitForURL((url) => url.searchParams.get('phase') === 'active');
await orgAgentRuntime.locator('[data-test="history-org-root"]').waitFor();
record('AORG-RV9-052-direct-agent-entry-reuses-baseline-agent-runtime',
  await orgAgentRuntime.getByText('Summarize the controlled prototype evidence.', { exact: true }).count() === 1
    && await orgAgentRuntime.getByText('The current prototype evidence is deterministic and isolated.', { exact: true }).count() === 1
    && await orgAgentRuntime.locator('[data-test="history-configured-team-placement"] button[disabled]').count() === 1
    && await orgAgentRuntime.locator('[data-test="history-task-agent-row"]').count() === 0
    && await orgAgentRuntime.locator('[data-test="history-task-team-row"]').count() === 0,
  { runtimeSurface: 'accepted Agent workspace', enteredTeamExpanded: false, taskLineage: 0 });
await orgAgentRuntime.close();
...
record('AORG-RV9-036-org-handoff-editor-validates-complete-draft',
...
record('AORG-RV9-037-org-handoff-endpoint-eligibility',
...
record('AORG-RV9-038-when-conditions-are-orderable',
...
record('AORG-RV9-039-handoff-draft-can-be-canceled',
...
record('AORG-RV9-040-handoff-authoring-supports-crud-reorder-and-atomic-save',
...
await capture(orgEdit, 'REV-AORG-RV9-015', 'REV-AORG-RV9-015-agent-org-handoff-authoring.png', 'Clean Agent Org handoff authoring with From, To, and ordered When guidance');
...
record('AORG-RV9-041-saved-handoff-definition-is-inspectable',
...
record('AORG-RV9-042-self-resolving-delivery-is-rejected',
...
await orgInvalidManager.locator('[data-test="apply-handoff-draft"]').click();
record('AORG-RV9-043-duplicate-effective-pair-is-rejected',
...
record('AORG-RV9-044-org-member-impact-blocks-atomic-save',
...
record('AORG-RV9-019-narrow-layout', overflow.scrollWidth === overflow.viewport
  && await narrow.getByRole('heading', { name: 'Software Development Department' }).count() === 1,
{ overflow });
await narrow.close();

record('AORG-RV9-020-no-runtime-errors', runtimeErrors.length === 0, { runtimeErrors });
...
await fs.writeFile(path.join(ticketRoot, 'browser-validation-rv-009.json'), `${JSON.stringify(result, null, 2)}\n`);
