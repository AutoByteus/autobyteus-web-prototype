...
record('AORG-RV3-001-team-catalog',
...
record('AORG-RV3-002-separated-primary-navigation',
...
record('AORG-RV3-003-team-catalog-preserves-baseline-visual-language',
...
record('AORG-RV3-021-baseline-reload-feedback',
...
record('AORG-RV3-022-baseline-search-behavior',
...
record('AORG-RV3-004-team-authoring-agent-only',
...
record('AORG-RV3-005-exactly-one-team-coordinator',
...
record('AORG-RV3-006-org-catalog',
...
record('AORG-RV3-007-org-direct-composition',
...
record('AORG-RV3-008-org-authoring-membership',
...
record('AORG-RV3-009-org-has-no-coordinator-control',
...
record('AORG-RV3-010-team-reference-preservation',
...
record('AORG-RV3-011-org-launch-requires-entry',
...
record('AORG-RV3-012-team-entry-resolves-through-coordinator',
...
record('AORG-RV3-013-launch-carries-exact-entry',
...
record('AORG-RV3-016-task-team-disclosure-and-child-focus',
...
record('AORG-RV3-017-task-team-child-is-selectable-runtime-identity',
...
record('AORG-RV3-018-standalone-team-history-remains-distinct',
...
record('AORG-RV3-019-narrow-layout', overflow.scrollWidth === overflow.viewport
  && await narrow.getByRole('heading', { name: 'Software Development Department' }).count() === 1,
{ overflow });
await narrow.close();

record('AORG-RV3-020-no-runtime-errors', runtimeErrors.length === 0, { runtimeErrors });
...
await fs.writeFile(path.join(ticketRoot, 'browser-validation-rv-003.json'), `${JSON.stringify(result, null, 2)}\n`);
