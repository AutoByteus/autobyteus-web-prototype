...
const evidenceRoot = path.join(ticketRoot, 'review-evidence', 'rv-007');
...
record('AORG-RV7-001-team-catalog',
...
record('AORG-RV7-002-separated-primary-navigation',
...
record('AORG-RV7-003-team-catalog-preserves-baseline-visual-language',
...
record('AORG-RV7-021-baseline-reload-feedback',
...
record('AORG-RV7-022-baseline-search-behavior',
...
record('AORG-RV7-004-team-authoring-agent-only',
...
record('AORG-RV7-005-exactly-one-team-coordinator',
...
record('AORG-RV7-023-team-detail-preserves-baseline-card-hierarchy',
...
record('AORG-RV7-024-team-detail-keeps-flat-semantics-without-cross-surface-chrome',
...
record('AORG-RV7-031-team-handoff-detail-is-explicit-and-clean',
...
record('AORG-RV7-025-team-member-opens-preserved-agent-detail',
...
record('AORG-RV7-026-agent-detail-returns-to-future-team-context',
...
record('AORG-RV7-027-team-detail-narrow-preservation',
...
record('AORG-RV7-032-team-local-editor-limits-endpoints-to-direct-agents',
...
record('AORG-RV7-033-team-member-impact-blocks-atomic-save',
...
record('AORG-RV7-006-org-catalog',
...
record('AORG-RV7-007-org-direct-composition',
...
record('AORG-RV7-028-org-reload-feedback',
...
record('AORG-RV7-029-org-search-behavior',
...
record('AORG-RV7-030-org-catalog-narrow-layout',
...
record('AORG-RV7-008-org-authoring-membership',
...
record('AORG-RV7-009-org-has-no-coordinator-control',
...
record('AORG-RV7-010-team-reference-preservation',
...
record('AORG-RV7-034-org-description-contains-no-invented-summary-data',
...
record('AORG-RV7-035-org-handoff-detail-is-explicit-and-clean',
...
record('AORG-RV7-011-org-launch-requires-entry',
...
record('AORG-RV7-012-team-entry-resolves-through-coordinator',
...
record('AORG-RV7-013-launch-carries-exact-entry',
...
record('AORG-RV7-016-task-team-disclosure-and-child-focus',
...
record('AORG-RV7-017-task-team-child-is-selectable-runtime-identity',
...
record('AORG-RV7-018-standalone-team-history-remains-distinct',
...
record('AORG-RV7-036-org-handoff-editor-validates-complete-draft',
...
record('AORG-RV7-037-org-handoff-endpoint-eligibility',
...
record('AORG-RV7-038-when-conditions-are-orderable',
...
record('AORG-RV7-039-handoff-draft-can-be-canceled',
...
record('AORG-RV7-040-handoff-authoring-supports-crud-reorder-and-atomic-save',
...
record('AORG-RV7-041-saved-handoff-definition-is-inspectable',
...
record('AORG-RV7-042-self-resolving-delivery-is-rejected',
...
await orgInvalidManager.locator('[data-test="apply-handoff-draft"]').click();
record('AORG-RV7-043-duplicate-effective-pair-is-rejected',
...
record('AORG-RV7-044-org-member-impact-blocks-atomic-save',
...
record('AORG-RV7-019-narrow-layout', overflow.scrollWidth === overflow.viewport
  && await narrow.getByRole('heading', { name: 'Software Development Department' }).count() === 1,
{ overflow });
await narrow.close();

record('AORG-RV7-020-no-runtime-errors', runtimeErrors.length === 0, { runtimeErrors });
...
await fs.writeFile(path.join(ticketRoot, 'browser-validation-rv-007.json'), `${JSON.stringify(result, null, 2)}\n`);
