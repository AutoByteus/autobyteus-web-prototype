...
- Prototype revision: `RV-006` production-native Team/Org separation candidate. Ticket commit pending this revision's repository finalization; unapproved and unintegrated.
