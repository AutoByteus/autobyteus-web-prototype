...
- Product response: implemented and retained through RV-010
...
RV-010 keeps the user-approved clean treatment: each Handoff shows From, To,
...
- Status: `Resolved; Product response implemented in RV-010 and awaiting user review`
...
non-normative until the user explicitly approves RV-010.
