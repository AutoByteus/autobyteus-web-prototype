# Focused Review Guide — AgentOrg Mounted-Team Member Overrides (RV-001)
...
1. **Initial:** confirm `Member overrides` is collapsed and the surrounding AgentOrg configuration remains unchanged.
...
- Browser validation: `review-evidence/rv-001/browser-validation.json` — `11/11` pass, zero browser errors.
- Desktop captures: `RV-001`–`RV-004` under `review-evidence/rv-001/`.
- Narrow capture: `RV-005-outer-open-teams-collapsed-narrow-390x844.png`.
