...
function ModelRunTable({ focus }: { focus: boolean }) {
  return <section className="run-table-section"><div className="run-table-heading"><div><h3>Lifetime usage by model</h3><p>{focus ? "Same evidence language as Analytics." : "Dense diagnostics retained."}</p></div><span>3 models</span></div><div className="run-table-wrap"><table className="run-table"><thead><tr><th>Runtime / Model</th><th>Runs</th><th>Input</th><th>Output</th><th>Cache read</th><th>Thinking</th><th>Total cost</th></tr></thead><tbody><tr><td><strong>Codex · GPT-5.6 Sol</strong></td><td>2</td><td>61,200</td><td>18,800</td><td>11,280</td><td>5,640</td><td>$0.4200</td></tr><tr><td><strong>Claude SDK · Sonnet 4.5</strong></td><td>1</td><td>36,900</td><td>12,100</td><td>7,380</td><td>2,420</td><td>$0.3600</td></tr><tr><td><strong>Autobyteus · Local model</strong></td><td>1</td><td>16,900</td><td>6,100</td><td>2,600</td><td>1,220</td><td>No API bill</td></tr></tbody></table></div></section>;
}
