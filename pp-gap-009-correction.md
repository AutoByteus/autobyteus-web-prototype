...
Machine results: `/home/autobyteus/workspace/autobyteus-web-prototype/evidence/gap-009/gap-009-summary.json` and `gap-009-results.json`.
...
Direct replay state record: `/home/autobyteus/workspace/autobyteus-web-prototype/evidence/gap-009/direct-browser-tool-replay.txt`.
